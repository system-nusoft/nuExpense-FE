  ...
  if (step === "analyzing") {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center gap-6 text-center">
        <div className="w-20 h-20 bg-[#d5e2ea] rounded-full flex items-center justify-center">
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6 flex flex-col gap-4">
        ...
        {/* Camera button — mobile only (capture attribute is ignored on desktop) */}
        {isMobile && (
          <>
            ...
            <label className="cursor-pointer">
              <input
                ...
                className="hidden"
              />
              <div className="flex items-center justify-center gap-2 w-full py-3 border-2 border-dashed border-gray-300 rounded-xl hover:border-[#578bab] hover:bg-[#eef2f5] transition-colors text-sm text-gray-600 font-medium">
                <svg className="w-5 h-5 text-[#3e6378]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
